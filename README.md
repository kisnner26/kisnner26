...
ingeniería en sistemas de información computacionales, uam (managua, nicaragua).
backend transaccional, apps nativas de macOS/iOS, y contribuciones a open source.
macOS y windows por igual.

portfolio: **[kisnner26.github.io](https://kisnner26.github.io)**
...
- [radare2](https://github.com/radareorg/radare2/pull/26745) — 2 PRs mergeados
- [swift-nio](https://github.com/apple/swift-nio/pull/3744), [swift-nio-extras](https://github.com/apple/swift-nio-extras/pull/327), [swift-argument-parser](https://github.com/apple/swift-argument-parser/pull/972) — PRs abiertos
